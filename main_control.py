...
#         print()
        ...
        lateral_pos = nearest_waypoint.next(1.0)[0].transform.location
        vehicle_pos = vehicle_transform.location
         
        road_yaw = nearest_waypoint.transform.rotation.yaw / 180 * math.pi
...
#         print(vehicle_yaw)
        ...
        lateral_error = ((lateral_pos.x - (vehicle_pos.x + 1.44 * math.sin(vehicle_yaw))) ** 2 + (lateral_pos.y - (vehicle_pos.y + 1.44 * math.cos(vehicle_yaw))) ** 2) ** 0.5
        if (vehicle_pos.y < lateral_pos.y):
